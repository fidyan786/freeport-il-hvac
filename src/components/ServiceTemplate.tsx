          ...
          <article>
            ...
            <div className="mt-6 grid gap-4">
              {service.problems.map((problem) => (
                <div key={problem.title} className="border border-line bg-white p-5">
            ...
            <ol className="mt-6 grid gap-4">
              {service.process.map((step, index) => (
                <li key={step.title} className="bg-white p-5 ring-1 ring-line">
          ...
          <div>
            ...
            <ul className="mt-4 grid gap-3 text-muted">
              {service.why.map((item) => (
                <li key={item} className="bg-white p-4 ring-1 ring-line">
                  {item}
                </li>
              ))}
            </ul>
